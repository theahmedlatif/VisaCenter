            ...
            <table class="table table-hover table-responsive table-sm">
                ...
                @foreach($passports as $passport)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('staff.passport.edit',$passport->id)}}" class="btn btn-sm btn-success">Handle</a>
                            <a href="{{route('staff.passport.show',$passport->id)}}" class="btn btn-sm btn-info">View</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
